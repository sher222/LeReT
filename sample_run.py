...
setup_command = "export PATH=/iris/u/sherylh/anaconda3/bin:$PATH; . activate dspy; export WANDB_API_KEY=YOUR_WANDB_KEY; export HF_TOKEN=YOUR_HF_TOKEN; cd /iris/u/sherylh/LeReT/direct-preference-optimization"
